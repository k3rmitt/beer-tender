...
describe('List beer features', () => {
  afterEach(() => {
    nock.cleanAll();
  });

  /*it('renders without crashing', () => {
    const store = mockStore({navigation: {}, beers: [], cache: {}});p
    var scope = nock('https://api.punkapi.com')
      .get('/v2/beers?page=1&per_page=20')
      .reply(200, page1);
    const div = document.createElement('div');
    ReactDOM.render(<ListBeer store={store} />, div);
  });*/
  it('correctly render a list', () => {
    const store = mockStore({beers: [], navigation: {}, cache: {}});

    nock('https://api.punkapi.com')
      .get('/v2/beers?page=1&per_page=20')
      .reply(200, page1);
    const component = renderer.create(<ListBeer store={store} />);
...
const page1 = [
  ...
  },
  {
    ...
    brewers_tips: "Don't worry too much about controlling the temperature with the Belgian yeast strain - just make sure it doesn't rise above 30\xB0C!",
    contributed_by: 'Sam Mason <samjbmason>',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        {name: 'Pale Ale Malt', amount: {value: 6.13, unit: 'kilograms'}},
  ...
  },
  {
    ...
    brewers_tips: 'If you are struggling to get that authentic head retention increase your mash temperature to about 70\xB0C.',
    contributed_by: 'Sam Mason <samjbmason>',
  },
];
